...
class StockLocation(models.Model):
    ...
    x_studio_many2many_field_7kpUe = fields.Many2many('res.users', string='Users (Cell Visibility)')
    ...
    x_studio_users_internal_transfer = fields.Many2many('res.users', string='Users (Internal Transfer)')
    x_studio_users_stock_location = fields.Many2many('res.users', string='Users (Stock Location)')
